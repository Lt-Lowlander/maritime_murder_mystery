...
users = User.create!([
  ...
  {email: "sample@email.com", password: "demonstration", faction_id: "2", role: "member", attendee: "David Atwater", position: "Entertainments Officer", character: "Vic Hammerstein", title: "49, American", tagline: "Always provides lavish entertainment spectaculars for passengers. Reports to the First Officer."},
