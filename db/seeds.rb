...
users = User.create!([
  ...
  {email: "a@email.com", password: "flooring", faction_id: "1", role: "member", attendee: "party guest", position: "First Officer", character: "Daniel Warren", title: "35, American", tagline: "Competent First Officer, well liked by the crew and expected to be given command of a ship as soon as possible. Reports to the Captain."},
  {email: "b@email.com", password: "seating", faction_id: "1", role: "member",  attendee: "party guest",position: "Second Officer", character: "David Whitworth", title: "47, English", tagline: "Reliable and competent officer, previously sailed with the Royal Merchant Navy. Reports to the First Officer."},
  {email: "c@email.com", password: "watchmen", faction_id: "1", role: "member",  attendee: "party guest",position: "Third Officer", character: "Christina Younger", title: "36, American", tagline: "The highest placed woman in the Cruise Line and has sacrificed her personal life for her career. Reports to the Second Officer."},
  ...
  {email: "e@email.com", password: "exoskeleton", faction_id: "1", role: "member", attendee: "party guest", position: "Cocktail Stewardess", character: "Julia Morteblanca", title: "25, Italian", tagline: "Previously worked in the Waldorf Astoria as America’s first professional female cocktail mixer. Reports to the Chief Purser."},
  ...
  {email: "i@email.com", password: "tempered", faction_id: "1", role: "member", attendee: "party guest", position: "Cabaret Singer", character: "Jennifer Floreste", title: "41, American", tagline: "Previously starred at the London Palladium, a famous singer on her last voyage. Reports to the Entertainments Officer."},
  {email: "j@email.com", password: "tethering", faction_id: "2", role: "member", attendee: "party guest", character: "Sir Rory Canter", title: "Baronet, 54", tagline: "Rumoured to be the richest man in Great Britain."},
  ...
  {email: "m@email.com", password: "milkman", faction_id: "2", role: "member", attendee: "party guest", character: "Rachel Finkelstein", title: "Jeremiah’s wife and business partner, 58", tagline: "Rachel is renowned for her financial acumen."},
  {email: "n@email.com", password: "rifling", faction_id: "2", role: "member", attendee: "party guest", character: "PJ Nichols", title: "Singer, 27", tagline: "Although predominantly a Music Hall singer and entertainer, PJ has recently returned from Hollywood, after ‘trying out’ for several of the main studios."},
  ...
  {email: "t@email.com", password: "ideation", faction_id: "2", role: "member", attendee: "party guest", character: "Maximillian von Grafenberg", title: "German Procurement Minister, 47", tagline: "Has been in America for the last year, and is now returning to Germany."},
  ...
  {email: "w@email.com", password: "fieldnotes", faction_id: "2", role: "member", attendee: "party guest", character: "Eldon Dumlop II", title: "American socialite, 47", tagline: "Rich American heir to the Dumlop rubber fortune."},
  ...
  {email: "y@email.com", password: "stepper", faction_id: "2", role: "member", attendee: "party guest", character: "Marie Hati", title: "French journalist, 40", tagline: "Writes passionate columnes for Le Monde, demanding equal rights for women, and increased spending on hospitals."},
