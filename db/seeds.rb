...
abilities = Ability.create!([
  {user_id: 1, power_name: "aa", power_desc: "aa"},
  {user_id: 2, power_name: "bb", power_desc: "bb"},
  {user_id: 3, power_name: "a", power_desc: "a"},
  {user_id: 4, power_name: "b", power_desc: "b"},
  {user_id: 5, power_name: "c", power_desc: "c"},
  {user_id: 6, power_name: "It's just a flesh wound", power_desc: "When you would have been injured, use this Ability and you take no damage."},
  {user_id: 6, power_name: "Tell me your secrets", power_desc: "After speaking briefly and in a trustworthy manner to another player, show them this and they must show you their Secret."},
  {user_id: 6, power_name: "Let’s gossip!", power_desc: "After speaking briefly to another player, show them your Information and this Ability. They must show you their Information."},
  {user_id: 7, power_name: "d", power_desc: "d"},
  {user_id: 8, power_name: "e", power_desc: "e"},
  {user_id: 9, power_name: "f", power_desc: "f"},
  {user_id: 10, power_name: "g", power_desc: "g"},
  {user_id: 11, power_name: "h", power_desc: "h"},
  {user_id: 12, power_name: "i", power_desc: "i"},
  {user_id: 13, power_name: "j", power_desc: "j"},
  {user_id: 14, power_name: "k", power_desc: "k"},
  {user_id: 15, power_name: "l", power_desc: "l"},
  {user_id: 16, power_name: "m", power_desc: "m"},
  {user_id: 17, power_name: "n", power_desc: "n"},
  {user_id: 18, power_name: "o", power_desc: "o"},
  {user_id: 19, power_name: "p", power_desc: "p"},
  {user_id: 20, power_name: "q", power_desc: "q"},
  {user_id: 21, power_name: "r", power_desc: "r"},
  {user_id: 22, power_name: "s", power_desc: "s"},
  {user_id: 23, power_name: "t", power_desc: "t"},
  {user_id: 24, power_name: "u", power_desc: "u"},
  {user_id: 25, power_name: "v", power_desc: "v"},
  {user_id: 26, power_name: "w", power_desc: "w"},
  {user_id: 27, power_name: "x", power_desc: "x"},
  {user_id: 28, power_name: "y", power_desc: "y"},
  {user_id: 29, power_name: "z", power_desc: "z"},
  ])

#create ability cells
cells = Cell.create!([
  {ability_id: 1, consumed: 0},
  {ability_id: 2, consumed: 0},
  {ability_id: 3, consumed: 0},
  {ability_id: 4, consumed: 0},
  {ability_id: 5, consumed: 0},
  {ability_id: 6, consumed: 0},
  {ability_id: 7, consumed: 0},
  {ability_id: 7, consumed: 0},
  {ability_id: 7, consumed: 0},
  {ability_id: 8, consumed: 0},
  {ability_id: 8, consumed: 0},
  {ability_id: 8, consumed: 0},
  {ability_id: 9, consumed: 0},
  {ability_id: 10, consumed: 0},
  {ability_id: 11, consumed: 0},
  {ability_id: 12, consumed: 0},
  {ability_id: 13, consumed: 0},
  {ability_id: 14, consumed: 0},
  {ability_id: 15, consumed: 0},
  {ability_id: 16, consumed: 0},
  {ability_id: 17, consumed: 0},
  {ability_id: 18, consumed: 0},
  {ability_id: 19, consumed: 0},
  {ability_id: 20, consumed: 0},
  {ability_id: 21, consumed: 0},
  {ability_id: 22, consumed: 0},
  {ability_id: 23, consumed: 0},
  {ability_id: 24, consumed: 0},
  {ability_id: 25, consumed: 0},
  {ability_id: 26, consumed: 0},
  {ability_id: 27, consumed: 0},
  {ability_id: 28, consumed: 0},
  {ability_id: 29, consumed: 0},
  {ability_id: 30, consumed: 0},
  ])
