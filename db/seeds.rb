...
factions = Faction.create!([
  {id: "1", fac_name: "Moderators"},
  {id: "2", fac_name: "Crew"},
  {id: "3", fac_name: "Passengers"},
  ])
...
users = User.create!([
  ...
  {email: "aerocricket@gmail.com", password: "mur_maid", faction_id: "2", role: "member", attendee: "David Atwater", position: "Entertainments Officer", character: "Vic Hammerstein", title: "49, American", tagline: "Always provides lavish entertainment spectaculars for passengers. Reports to the First Officer."},
  {email: "christine.t.attanasio@gmail.com", password: "ladybug", faction_id: "2", role: "member", attendee: "Christine Attanasio", position: "Master Chef", character: "Blaise de Richelieu", title: "50, French", tagline: "Temperamental culinary genius, signed on by Hammerstein at great expense. This is de Richelieu’s first voyage aboard the Libertania, and so far the cuisine is not up to expectations. Reports to the Third Officer."},
  {email: "juliai1291@gmail.com", password: "exoskeleton", faction_id: "2", role: "member", attendee: "Julia Iannacone", position: "Cocktail Stewardess", character: "Julia Morteblanca", title: "25, Italian", tagline: "Previously worked in the Waldorf Astoria as America’s first professional female cocktail mixer. Reports to the Chief Purser."},
  {email: "knight8@tcnj.edu", password: "carport", faction_id: "2", role: "member", attendee: "Hannah Knight", position: "Cabin Stewardess", character: "Catherine New", title: "18, English", tagline: "Only recently joined the Libertainia, but already knows everything about anything on board the ship. Reports to the Chief Purser."},
  {email: "Heather.schrepel@gmail.com", password: "squirrel", faction_id: "2", role: "member", attendee: "Heather Schrepel", position: "Cabin Stewardess", character: "Cynthia Petal", title: "32", tagline: "Has been working aboard liners for half of her life, and is competent and well liked by crew and passengers. Reports to the Chief Purser."},
  {email: "terrasilva.vix@gmail.com", password: "weather", faction_id: "2", role: "member", attendee: "Jim Phillips", position: "Trainee Steward", character: "Eric Lassiter", title: "20, Scottish", tagline: "Training to be a steward. Reports to the Chief Purser."},
  {email: "Andrea.j.Agra@gmail.com", password: "tempered", faction_id: "2", role: "member", attendee: "Andrea Agra", position: "Cabaret Singer", character: "Jennifer Floreste", title: "41, American", tagline: "Previously starred at the London Palladium, a famous singer on her last voyage. Reports to the Entertainments Officer."},
  {email: "sam@snug.ug", password: "tethering", faction_id: "3", role: "member", attendee: "Sam Richard", character: "Sir Rory Canter", title: "Baronet, 54", tagline: "Rumoured to be the richest man in Great Britain."},
  {email: "acbiggs92@gmail.com", password: "religion", faction_id: "3", role: "member", attendee: "Annie Biggs", character: "Lady Isabelle Canter", title: "33", tagline: "Young and pretty wife of Sir Rory, was previously an actress and ballet dancer."},
  {email: "jwkrizan@gmail.com", password: "sister", faction_id: "3", role: "member", attendee: "Jason Krizan", character: "Jeremiah Finkelstein", title: "Industrial Businessman, 61", tagline: "Owner of several large American manufacturing concerns, as well as the first aircraft factory outside of Europe."},
  {email: "aemmert@live.com", password: "milkman", faction_id: "3", role: "member", attendee: "Amanda Emmert", character: "Rachel Finkelstein", title: "Jeremiah’s wife and business partner, 58", tagline: "Rachel is renowned for her financial acumen."},
  {email: "john.w.petsche@gmail.com", password: "rifling", faction_id: "3", role: "member", attendee: "John Petsche", character: "PJ Nichols", title: "Singer, 27", tagline: "Although predominantly a Music Hall singer and entertainer, PJ has recently returned from Hollywood, after ‘trying out’ for several of the main studios."},
  {email: "jhr0189@gmail.com", password: "carpenter", faction_id: "3", role: "member", attendee: "Justin Richman", character: "Clark Ridgeway", title: "PJ's Manager, 35", tagline: "Has arranged several stupendously successful shows and tours for PJ in the past."},
  {email: "Chrispaclark@gmail.com", password: "whistle", faction_id: "3", role: "member", attendee: "Christian Clark", character: "Gilbert Ryce", title: "American Secretary of State, 68", tagline: "Ageing friend of the American President."},
  {email: "murich29@gmail.com", password: "company", faction_id: "3", role: "member", attendee: "Monica Urich", character: "Wilma Drew", title: "Ryce's Assistant, 32", tagline: "Gilbert Ryce’s assistant in the American State Department, always smooth and unruffled."},
  {email: "cbribiescas@gmail.com", password: "bumblebee", faction_id: "3", role: "member", attendee: "Carlos Bribiescas", character: "Sir Ranulph Royston", title: "British Minister of War, 63", tagline: "A widower, Sir Ranulph’s wife recently died in a riding accident."},
  {email: "susanvha@gmail.com", password: "channel", faction_id: "3", role: "member", attendee: "Susan Ha", character: "Elizabeth James", title: "Sir Ranulph’s Daughter, 19", tagline: "Elizabeth is divorcing her husband after he had an affair."},
  {email: "dom594@gmail.com", password: "ideation", faction_id: "3", role: "member", attendee: "Domenic Iannacone", character: "Maximillian von Grafenberg", title: "German Procurement Minister, 47", tagline: "Has been in America for the last year, and is now returning to Germany."},
  {email: "kyungbchoi@gmail.com", password: "volcano", faction_id: "3", role: "member", attendee: "Kyung Choi", character: "Armin Oberhausen", title: "Maximilian’s assistant, 39.", tagline: "Armin is ambitious and some say fancies the Maximilian’s job."},
  {email: "scarter1293@gmail.com", password: "battle", faction_id: "3", role: "member", attendee: "Stephen Carter", character: "Sasha Alexanderovich Ilyatkin", title: "Russian Minister, 45", tagline: "Sasha was in New York to sign trade agreements with the American Government."},
  {email: "lemay@bu.edu", password: "fieldnotes", faction_id: "3", role: "member", attendee: "Mark Lemay", character: "Eldon Dumlop II", title: "American socialite, 47", tagline: "Rich American heir to the Dumlop rubber fortune."},
  {email: "stephsavir@gmail.com", password: "trouble", faction_id: "3", role: "member", attendee: "Stephanie Savir", character: "Candice Dumlop", title: "American socialite and Eldon’s wife, 21", tagline: "Very glamorous and flirtatious rich American."},
  {email: "jgm616@gmail.com", password: "stepper", faction_id: "3", role: "member", attendee: "Janet May", character: "Marie Hati", title: "French journalist, 40", tagline: "Writes passionate columnes for Le Monde, demanding equal rights for women, and increased spending on hospitals."},
  {email: "Kaitpnr75@gmail.com", password: "direction", faction_id: "3", role: "member", attendee: "Kait Piñero", character: "Aggie Marbles", title: "American, 26", tagline: "Aggie is travelling with the Finkelsteins. She has made a name for herself as an amateur sleuth."},
  ])
